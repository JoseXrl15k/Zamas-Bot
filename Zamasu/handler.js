...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|mente|pero|tion|age|ous|ate|and|but|ify|ai|Zamasu|megu|a|s)/gi)) {
...
unwatchFile(file);
console.log(chalk.green('Actualizando "Zamasu/handler.js"'));
