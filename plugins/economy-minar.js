...
if (new Date - global.db.data.users[m.sender].lastmiming < 600000) return conn.reply(m.chat, `*⏰ Debes esperar ${msToTime(time - new Date())} para volver a minar*`, m, rcanal)
...
conn.fakeReply(m.chat, info, '0@s.whatsapp.net', '⚒️ *Minando.. - Zamas Bot* ✨', 'status@broadcast' )
await m.react('⛏️')
