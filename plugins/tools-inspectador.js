...
await conn.sendMessage(ch, { text: `🌹 Ao-Horie ha cambiando la imagen del canal *${chtitle}* con éxito.`, contextInfo: {
externalAdReply: {
title: "ンꣁ𑰰🌹-𝙉𝙊𝙏𝙄𝙁𝙄𝘾𝘼𝘾𝙄𝙊᷃𝙉-🌹ི",
...
await conn.sendMessage(ch, { text: `🌹 Ao-Horie ha eliminado la imagen del canal *${chtitle}* con éxito.`, contextInfo: {
externalAdReply: {
title: "ンꣁ𑰰🌹-𝙉𝙊𝙏𝙄𝙁𝙄𝘾𝘼𝘾𝙄𝙊᷃𝙉-🌹ི",
body: '🫡 Foto de perfil del canal eliminada.',
thumbnailUrl: pp,
sourceUrl: redes,
mediaType: 1,
showAdAttribution: false,
...
await conn.sendMessage(ch, { text: `🌹 Ao-Horie ha establecido el modo de reacciones como \`"${mode}"\` para el canal *${chtitle}*`, contextInfo: {
externalAdReply: {
title: "ンꣁ𑰰🌹-𝙉𝙊𝙏𝙄𝙁𝙄𝘾𝘼𝘾𝙄𝙊᷃𝙉-🌹ི",
...
await conn.sendMessage(ch, { text: `🌹 Ao-Horie ha cambiado el nombre del canal *${name}*\n\n*Anterior nombre:* ${chtitle}\n*Nuevo nombre:* ${name}`, contextInfo: {
externalAdReply: {
title: "ンꣁ𑰰🌹-𝙉𝙊𝙏𝙄𝙁𝙄𝘾𝘼𝘾𝙄𝙊᷃𝙉-🌹ི",
...
await conn.sendMessage(ch, { text: `🌹 Ao-Horie ha modificado la descripción del canal *${chtitle}*`, contextInfo: {
externalAdReply: {
title: "ンꣁ𑰰🌹-𝙉𝙊𝙏𝙄𝙁𝙄𝘾𝘼𝘾𝙄𝙊᷃𝙉-🌹ི",
