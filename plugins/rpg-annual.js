const annualReward = {
    cookies: 100, // Cantidad de Cookies que se otorgan
    money: 2000,  // Cantidad de ˙˚ʚ₍ ᐢ. ̫ .ᐢ ₎ɞ˚ ᴢᴀᴍᴀs ʙᴏᴛ Coins que se otorgan
...
var handler = async (m, { conn }) => {
    ...
    global.db.data.users[m.sender].cookies += annualReward.cookies;
...
Recursos:
🍪 cookies : *+${annualReward.cookies}*
💎 Diamantes : *+${annualReward.diamond}*
🪙 Coins : *+${annualReward.coin}*
✨ Xp : *+${annualReward.exp}*`, m, rcanal);
}
